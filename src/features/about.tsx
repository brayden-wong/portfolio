...
export const About = () => {
  return (
    ...
    >
      ...
      >
        <div className="space-y-4 overflow-y-hidden rounded bg-black/90 px-4 pt-1 pb-2 md:px-8">
...

{
  ...
  <h4 className="relative left-2 py-1.5 text-left text-2xl font-semibold sm:text-3xl">
    Here is a <span className="underline decoration-teal-400/80">little</span>{' '}
    about me.
  </h4>
  <AboutText />
</div>; */
